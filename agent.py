...
class Agent:
    ...
    def sample_experiences(self, batch_size):
        ...
        for field_index in range(5):
            b = []
            # a.append(np.array([experience[field_index] for experience in batch]))
            for experience in batch:
                b.append(experience[field_index])
    ...
    def training_step(self, batch_size):
        ...
        target_Q_values = (rewards + self.gamma * np.max(self.model.predict(next_states)))
        ...
        #
        # self.model.fit(self.model(states), target_Q_values)
